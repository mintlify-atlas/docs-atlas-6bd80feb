...
<CardGroup cols={2}>
  <Card title="Advanced Usage" icon="rocket" href="/guides/training-models">
    Learn about model training, feature engineering, and custom predictions
  </Card>
  
  <Card title="API Reference" icon="code" href="/api/models/train">
    Explore the complete TRIFID Python API
  </Card>
  
  <Card title="TRIFID Modules" icon="puzzle-piece" href="/modules/qsplice">
    Deep dive into QSplice, Pfam effects, and fragment labeling
  </Card>
  
  <Card title="Use Cases" icon="lightbulb" href="/examples/fgfr1">
